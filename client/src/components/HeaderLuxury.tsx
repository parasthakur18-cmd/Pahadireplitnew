    ...
    <header className="sticky top-0 z-50 bg-gradient-to-r from-primary via-orange-700 to-primary text-white border-b-4 border-orange-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex items-center justify-between">
          <Link href="/">
            <a className="flex items-center gap-4 hover-elevate rounded-lg px-4 py-2 -ml-4">
              <div className="w-14 h-14 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-white/30 shadow-xl">
                <Leaf className="w-7 h-7 text-white" />
              </div>
              <div>
                <h1 className="font-serif text-3xl font-bold">The Pahadi</h1>
                <p className="text-xs text-white/80 font-semibold tracking-widest">HIMALAYAN EXCELLENCE</p>
              </div>
            </a>
          </Link>
